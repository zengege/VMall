...
.bottom_cang img{
	        	...
	        	<div id="searchBar_area">
	        		<div id="search_bar_form">
	        			<form  method="get">
	        				...
	        				<input type="submit" class="button" value="搜索" style="position: absolute;top: 43px;right: 20px;"/>
	        			</form>
	        		</div>
   ...
   <iframe src="frameset.jsp" scrolling="yes" frameborder="0" style="width:1300px; height:1500px;" > </iframe>
<script>
		function go(a){
